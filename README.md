...
Windows üzerinde Mi Router 4A Gigabit Edition model routerınıza çok kısa sürede OpenWRT kurabileceksiniz.  
Yöntem yalnızca MediaTek MT7621 tabanlı, Mi 4A Gigabit modeli için geçerlidir.  
